...
class MessageTableEntry(db.Model):
    ...
    sender_id = db.Column(ForeignKey(ClientTableEntry.client_id, ondelete='CASCADE'), name='sender_id',
                          type_=db.Integer, nullable=False)
    receiver_id = db.Column(ForeignKey(ClientTableEntry.client_id, ondelete='CASCADE'), name='receiver_id',
                            type_=db.Integer, nullable=False)
